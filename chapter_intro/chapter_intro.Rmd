...
author: "Mylène Feuillade, Gustave Kenedi, Florian Oswald, Junnan He, Daniel Gyetvai"
...
# Some Examples of Questions in Econometrics
...
# This course: Introduction to Econometrics...

--

### Econometrics is a set of ***techniques and methods*** ... 

--
* ... and requires first and foremost adopting ***certain ways of thinking*** ...

    * ... about the process by which the data we have were generated.

--
* Although we will cover methods leading up to and including ***linear regression***, ... 

--
* ... econometrics is not about running regressions, ***econometrics is about thinking***.

    * Learning to think and thinking itself ***takes more time*** than learning to run regressions using software.

    * ***One*** carefully developed ***thought*** is ***worth more than*** a ***dozen of thoughtless regressions***.
...
--
* In econometrics we are constrained by what is 
...
--
* In this course, we will use ***data available on the internet*** with all their advantages and limitations.
...
* ***Only take-home*** assignments to be submitted via moodle: [https://moodle.sciences-po.fr/course/view.php?id=39709](https://moodle.sciences-po.fr/course/view.php?id=39709)
    
    * There will be ***no in-class assignment***.
    
    * There will be ***no exam***.

--

* There will be **three quizzes** on Moodle. [3 $\times$ 10% = 30%]

    * Submitted ***individually***.

    * ***One*** quiz ***at a time***.

    * Each quiz ***announced in advance***.
...
* There will be a **midterm case study** [30%]

    * Can be done ***alone or in groups of 2-3***.

    * ***Topic and data***: both will be ***assigned***, i.e. no need to choose.
    
    * Timing: $\approx$ mid-March.
    
    * You will have ***two weeks to complete it***.

--

* There will be a **final project case study** [40%]

    * Can be done ***alone or in groups of 2-3***.

    * ***Topic and data***: chosen by ***yourself/ves***.
    
    * Needs to ***include multiple linear regression analysis***.
    
    * Deadline: $\approx$ end of April / beginning of May.
...
Session 1 (today): ***Introduction***

Sessions 2, 3, 4: ***Tidying, Visualising and Summarising Data***

Sessions 4, 5: ***Simple Linear Regression***

Sessions 5, 6: ***Introduction to Causality***

Sessions 7, 8: ***Multiple Linear Regression***

*Midterm Project*

Sessions 8, 9: ***Linear Regression Extensions***

Sessions 10, 11: ***Sampling, Confidence Intervals and Hypothesis Testing***

Sessions 11, 12: ***Statistical Inference, Regression Inference***
...
* By default, and especially for urgent matters, ***contact by email***:
[daniel.gyetvai@sciencespo.fr](mailto:daniel.gyetvai@sciencespo.fr) (for Paris), [jeteesha.foollee@sciencespo.fr](mailto:jeteesha.foollee@sciencespo.fr) (for Reims) 

* We will use ***Slack mostly for exchanging code***.

--

***Class conduct and expectations***

* *Late work:* Will not be accepted unless you have a very good reason.

* *Cheating:* You will get 0. Just do not cheat, it is honestly not worth it.

* *Working in groups:* You are encouraged to work together as much as possible. Be inclusive. Do not free ride.
